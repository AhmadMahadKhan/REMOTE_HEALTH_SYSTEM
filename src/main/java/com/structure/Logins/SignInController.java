...
public class SignInController {
    ...
    @FXML void signInButton(ActionEvent actionEvent) throws SQLException, IOException {
        ...
        if(!usernameText.contains("@gmail.com")&&!usernameText.contains("@seecs.edu.pk")){

            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText("Invalid domain");
            alert.setContentText("Acceptable domain are \"@gmail.com\" or\"@seecs.edu.pk\"");
            alert.showAndWait();
            return;
        }
        ...
        if (user instanceof Patient) {
            ...
            controller.patientDetailsButton();
            ...
            Parent root = loader.load();
            AdministratorController controller = new AdministratorController((Administrator) user);
            controller = loader.getController();
            controller.setAdmin((Administrator) user);
            controller.adminDetailsButton("Administrator");
